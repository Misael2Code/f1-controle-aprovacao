...
class Aprovadas extends StatefulWidget {
  const Aprovadas({Key? key}) : super(key: key);

  @override
  State<Aprovadas> createState() => _AprovadasState();
}

class _AprovadasState extends State<Aprovadas> {
  ...
  void initState() {
    super.initState();
    pendentes = fetchConsulta('APR', _rotNap);
  }
                            ...
                            TextButton(
                                onPressed: () async {
                                  ...
                                  for (Model_Campos pendentes
                                      in await fetchConsulta('APR', _rotNap)) {
                                                                      ...
                                                                      if (apr.contains(
                                                                        ...
                                                                        showDialog(
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return AlertDialog(
                                                                                title: const Text('Concluído!'),
                                                                                content: const Text('Processado com sucesso!'),
                                                                                actions: [
                                                                                  ElevatedButton(onPressed: () => Navigator.push(context, MaterialPageRoute(builder: ((context) => Controles(setRot: 0)))), child: Text('OK'))
                                                                                ],
                                                                              );
                                                                            });
                                                                      } else {
